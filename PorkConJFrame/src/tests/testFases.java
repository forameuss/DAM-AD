...
import fases.GestionFases;
import fases.TipoFase;
import objetos.Arma;
import objetos.EnemigoImpl;
import objetos.Pocion;

public class testFases {

	public static void main(String[] args) {
		// Fase 1
		String s11 = "\nEstás condenado a morir incinerado en la plaza del pueblo por tus graves delitos contra el reino de Java."
				+ "\nLos cargos de los que se te acusan son: \"herencia múltiple\",  \"no saber controlar los bucles\",  \"no usar excepciones\" "
				+ "\ny lo más grave de todo, \"hacer métodos sin interfaces\". Te quedan pocas opciones, este parece ser tu final, ¿qué haces?";
		...
		// Fase 2
		String s2 = "\nHay gente que te apoyaba en silencio y te ven morir como un mártir en la plaza del pueblo. Eres un héroe, pero eres hombre muerto."
				+ "\nEstudia otro lenguaje en otra vida.";
		FaseImpl f2 = new FaseImpl(2, TipoFase.GAME_OVER, s2, null, null, null, null, 0);

		// Fase 3
		String s31 = "\nSuplicas piedad a viva voz, sin éxito aparente. El verdugo se dispone a prender la llama, cuando de repente, una flecha atraviesa"
				+ "\nla cabeza del ejecutor. Ante el asombro de todo el pueblo, notas que alguien te ha desatado."
				+ "\nDebes actuar rápido.";
		...
		// Fase 6
		String s61 = "Aprovechas el desconcierto para zafarte y sales corriendo de la plaza. Tras varios minutos, parece que la situación se ha calmado."
				+ "\nTienes que planear bien el siguiente paso.";
		...
		// Fase 7
		String s71 = "Tras merodear un poco, descubres una posada algo sobria pero bastante discreta. Parece el mejor sitio para esconderse, pero aún hay tiempo"
				+ "\npara recapacitar.";
		...
		// Fase 9
		String s91 = "Te acercas al extraño, está sentado solo, en un rincón de la posada. Es un hombre de altura media, marcado con muchas cicatrices y una mirada profunda."
				+ "\nTe sientas junto a él, éste se inclina hacia tí y te susurra."
				+ "\n\t-Sé quién eres. Corres muchísmo peligro si te quedas en la ciudad. Tienes que hacerme caso, huye, te necesitan fuera."
		...
		// Fase 11
		String s111 = "Abandonas la ciudad sin problemas, y sigues el camino para alejarte lo máximo posible de tus perseguidores. Al poco de alejarte de las"
				+ "\nmurallas, divisas a un mercader a lo lejos. Puede que sea interesante interactuar con el...";
		...
		String s121 = "Te acercas al mercader y sin ni siquera decir una palabra éste te empieza a vender sus productos."
				+ "\n\t-¡Bien implementado seáis, mi amigo! Tengo las mejores interfaces de todo el reino de java, con estudios de calidad "
				+ "\n\t y las APIs más exóticas de todo el mundo comentado. ¿Te gustaría echar un vistazo a mi inventario?"
		...
		GestionFases.escribeFases(fases, "src/Fases.dat");
		System.out.println("Fases creadas y guardadas.");
